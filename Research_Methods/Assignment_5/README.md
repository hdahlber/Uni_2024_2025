...
We want to compare the performance of four test generation algorithms named ALG1 to ALG4. In this task we focus in this question
...
However, do not include your name or student number, to ensure that  reviews are anonymous.

Upload your Jupyter notebook as your solution. You do not need to upload the experimental data file.
